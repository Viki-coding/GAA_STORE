"""
Django settings for gaa_store project.
...
ROOT_URLCONF = 'gaa_store.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            BASE_DIR / 'templates',  # <- use Pathlib here for clarity
...
WSGI_APPLICATION = 'gaa_store.wsgi.application'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'gaa-store@example.com'
